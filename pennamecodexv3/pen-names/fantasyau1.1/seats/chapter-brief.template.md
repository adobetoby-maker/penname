# CHAPTER BRIEF — {{book}} — Chapter {{NN}} "{{title}}"
Compiled {{date}} by the orchestrator. **Two pages. This is what the author drafts from.** The canon walls not listed here still bind and are enforced by the editor and verifier; the author is not asked to memorize them.

## 1. Load (four files, in order)
1. `pen-names/fantasyau1.1/SOUL.md`
2. `pen-names/fantasyau1.1/VOICE.md`
3. `chapters/ch{{NN-1}}-*.md` — the previous chapter, in full
4. This brief

## 2. Where the last chapter left the board
{{ledger_delta — ≤200 words: day, place, who is present, what is owed, what is known, injuries}}

## 3. The card (verbatim from the architecture)
{{card}}

## 4. The want
{{want_line — the protagonist's want for this book, and how this chapter presses it. One or two sentences.}}
...
## 6. Five walls that matter for THIS chapter
1. {{wall}}
2. {{wall}}
3. {{wall}}
4. {{wall}}
